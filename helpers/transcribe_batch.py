...
Walks <videos_dir> for common video extensions, runs FunASR on
...
Usage:
    ...
    python helpers/transcribe_batch.py <videos_dir> --model paraformer-zh
...
from transcribe import DEFAULT_MODEL, DEFAULT_PUNC_MODEL, DEFAULT_VAD_MODEL, transcribe_one


VIDEO_EXTS = {".mp4", ".MP4", ".mov", ".MOV", ".mkv", ".MKV", ".avi", ".AVI", ".m4v", ".flv", ".FLV"}
